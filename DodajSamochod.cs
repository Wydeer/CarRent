...
namespace Wypozyczalnia
{
    public partial class DodajSamochod : Form
    {
        ...
        private void btn_DSDodaj_Click(object sender, EventArgs e)
        {
            ...
            connection.Open();
            SqlCommand command = new SqlCommand("INSERT INTO Samochod (marka, model, numer_rej, rok_produkcji, rodzaj_paliwa, kolor, cena_za_dzien, rodzaj_skrzyni, kaucja, status) VALUES (@marka, @model, @numer_rej,@rok_produkcji, @rodzaj_paliwa, @kolor, @cena_za_dzien, @rodzaj_skrzyni, @kaucja, @status)", connection);
